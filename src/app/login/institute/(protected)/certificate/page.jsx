...
export default function CertificatePage() {
  ...
  const loadResults = async () => {
    ...
    try {
      ...
      // Filter manually
      const passedStudents = res.documents.filter(r =>
        r.grade !== "F" && r.createdById === user.$id
      );
              ...
              results.map((r, index) => {
                ...
                return (
                  ...
                  <tr key={r.$id}>
                    ...
                    <td className="border p-2">OFFLINE</td>

                    <td className="border p-2">{objective}</td>

                    <td className="border p-2">{practical}</td>
                    ...
                    <td className="border p-2">{r.examDate || "-"}</td>
